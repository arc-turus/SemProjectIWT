                    ...
                    <tbody>
                        ...
                        foreach ($res as $row) 
                        {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="service_edit.php?id=<?php echo $row['service_id']; ?>" class="btn btn-xs btn-warning">Edit</a>
                                    <a href="service_delete.php?id=<?php echo $row['service_id']; ?>" class="btn btn-xs btn-danger" onClick="return confirm('Are you sure?');">Delete</a>
                                </td>
                            </tr>
                            <?php
                        }
